...
urlpatterns = [
    ...
    url(r'^note/','article.views.note_index',name="note"),
    url(r'^albums/','article.views.albums',name="albums"),#梦幻岛首页
    ...
    #每个分类页下面的文章
    url(r'^articleTag/(?P<tag>\w+)/', 'article.views.tagDetail', name="tagDetail"),
    #每个标签页下面的文章
    url(r'^tags/$','article.views.tags',name="tags"),#标签
    ...
    #url(r'^base/$','article.views.base', name = "base"),
